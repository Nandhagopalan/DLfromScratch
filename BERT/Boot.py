...
def train(net, criterion, opti, train_loader, val_loader, args):
    ...
    for ep in range(args.max_eps):
        ...
        if val_acc > best_acc:
            ...
            best_acc = val_acc
            torch.save(net.state_dict(), 'Data/sstcls_{}_freeze_{}.dat'.format(ep, args.freeze_bert))
...
if __name__ == "__main__":
    ...
    st = time.time()
    train_set = SSTDataset(filename = 'Data/train.csv', maxlen = args.maxlen)
    val_set = SSTDataset(filename = 'Data/test.csv', maxlen = args.maxlen)
